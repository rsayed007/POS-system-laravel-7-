...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left">Add New Customer</h6>
        <a href="{{route('customer-list')}}" class="float-right btn btn-dark">Customers List</a>
      </div>
      <div class="card-body">
        <div class="table-responsive">
            ...
            <form method="POST" action="{{route('customer-store')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" placeholder="Enter email" value="{{old('email')}}" id="email" name="email">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="address"  cols="5" rows="3"></textarea>
                </div>
